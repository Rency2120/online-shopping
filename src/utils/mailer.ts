...
// export const sendOtpEmail = async (email: string, otp: string, name: string) => {
//   const subject = 'Verify your email with OTP';
//   const message = `Your One-Time Password (OTP) for email verification is: ${otp}. This OTP is valid for 15 minutes.`;
//   const templateName = 'otp'
//   const additionalData = {
//     name,
//     message
//   }
//   await sendEmail(email, subject, templateName, additionalData);
// }
